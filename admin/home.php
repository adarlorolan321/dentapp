...
<div class="container">
  ...
  <div class="row-fluid">
    <div>
      <h4>Total Pending Appointments:<?php echo $data['total']; ?></h4>
    </div></br>
  ...
  <table class='table table-bordered table-responsive' id='myTable'>
    ...
    ?>
      ...
      <td>
        ...
        <!-- <a class="" id="sendEmailButton"> | Send Email</a> -->
      </td>
    <?php
    }
    ?>
...
<script>
  ...
  document.getElementById("sendEmailButton").addEventListener("click", function() {
    // AJAX request to trigger the email sending action
    ...
    xhr.onreadystatechange = function() {
      ...
      if (xhr.readyState === 4 && xhr.status === 200) {
        ...
        // Display a message or perform any other action based on the response
